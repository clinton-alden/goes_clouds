...
# Mammoth Mountain ACM (Aerosol Cloud Mask) version - 50km x 50km domain
# Centered at: 37.6308°N, 119.0326°W
...
Usage: $0 [DOMAIN] [GOES] [BASE_DIR] [YEAR] [MONTH]
  DOMAIN   default: mammoth_acm
  GOES     default: goes16
  BASE_DIR default: /glade/derecho/scratch/cdalden/mammoth_acm
  YEAR     optional, e.g. 2025
  MONTH    optional, e.g. 03 or 3
Env:
  DOWNLOAD_SCRIPT (default ../../data_download/download-goes.py)
  START_YEAR (default 2025, used when YEAR/MONTH not provided)
  END_YEAR   (default 2025, used when YEAR/MONTH not provided)
...
# args / defaults
DOMAIN=${1:-mammoth_acm}
GOES=${2:-goes16}
DOWNLOAD_SCRIPT=${DOWNLOAD_SCRIPT:-../../data_download/download-goes.py}
BASE_DIR=${3:-/glade/derecho/scratch/cdalden/mammoth_acm}
YEAR_ARG=${4:-}
MONTH_ARG=${5:-}
...
process_month() {
    ...
    # Mammoth Mountain bounds for ACM
    # Center ~37.6308N, -119.0326W over ~50km x 50km domain.
