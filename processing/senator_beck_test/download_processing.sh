...
# Centered near: 37.90°N, 107.71°W
# Bounds: -108.00, 37.67, -107.42, 38.13
...
Usage: $0 [DOMAIN] [GOES] [BASE_DIR] [YEAR] [MONTH]
  DOMAIN   default: senator_beck
  GOES     default: goes16
  BASE_DIR default: /glade/derecho/scratch/cdalden/senator_beck
...
# args / defaults
DOMAIN=${1:-senator_beck}
GOES=${2:-goes16}
DOWNLOAD_SCRIPT=${DOWNLOAD_SCRIPT:-../../data_download/download-goes.py}
BASE_DIR=${3:-/glade/derecho/scratch/cdalden/senator_beck}
YEAR_ARG=${4:-}
MONTH_ARG=${5:-}
...
process_month() {
  ...
  month_num=$((10#${month_padded}))
    ...
    # Senator Beck Basin (CO) ~50km x 50km bounds.
