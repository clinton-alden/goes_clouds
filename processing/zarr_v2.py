#!/usr/bin/env python3
"""
Zarr Conversion Script v2
Source: https://github.com/clinton-alden/goes_clouds/blob/master/processing/zarr_v2.py

Processes GOES NetCDF files to create Zarr files for a full month.
Automatically deletes original NetCDF files after Zarr conversion.

Usage:
    python zarr_v2.py <directory> <year> <month> <goes_model> <domain>

Example:
    python zarr_v2.py /storage/cdalden/goes/colorado/ 2022 7 goes16 colorado
"""
...
def main():
    ...
    if len(sys.argv) != 6:
        ...
        print("Example: python zarr_v2.py /storage/cdalden/goes/colorado/ 2022 7 goes16 colorado")
        sys.exit(1)
