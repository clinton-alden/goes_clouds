...
Usage: $0 [DOMAIN] [GOES] [BASE_DIR] [YEAR] [MONTH]
  DOMAIN   default: mammoth
  GOES     default: goes16
  BASE_DIR default: /glade/derecho/scratch/cdalden/mammoth
...
BASE_DIR=${3:-/glade/derecho/scratch/cdalden/mammoth}
YEAR_ARG=${4:-}
MONTH_ARG=${5:-}
...
process_month() {
  ...
  month_num=$((10#${month_padded}))
    ...
    # Mammoth Mountain bounds using same syntax/order as colorado script.
