#!/usr/bin/env python
"""Submit one PBS job per month for the 2022 NLDAS point comparison."""
...
LOG_DIR = REPO / "analysis" / "logs_nldas_point_eval"
MONTH_RUNNER = REPO / "analysis" / "run_month_nldas_point_eval.sh"
...
def submit_month(args: argparse.Namespace, month: int) -> str:
    ...
    job_name = f"nldaspt{args.year}{month:02d}"
    cmd = [
        "qsub",
        "-A",
        args.account,
