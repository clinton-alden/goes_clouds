...
python ./download-goes.py -B noaa-goes16 -Y 2022 -M 7 -D 2 2 -p ABI-L2-ACMC -c C02 -b -109 37 -104 41 -d /glade/u/home/cdalden/scratch/colorado_acm

# for day in $(seq 1 1); do # don't need to add 1 to the end day since sh is inclusive
#     for channel in C02 C05 C13; do
#         # Run the download script
#         python ./download-goes.py -B noaa-goes16 -Y 2023 -M 1 -D $day $day -p ABI-L1-RadC -c $channel -b -109 37 -104 41 -d /storage/cdalden/goes/colorado
#     done
# done