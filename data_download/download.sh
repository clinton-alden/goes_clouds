...
for day in {8..31}; do
    for channel in C02 C05 C13; do
        python ./download-goes.py --bucket noaa-goes17 --year 2022 --month 7 --days $day $day --product ABI-L1b-RadC --channel $channel --bounds -125 46 -121 49 --dir /storage/cdalden/goes/washington
