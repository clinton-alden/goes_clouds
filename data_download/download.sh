...
for channel in C02 C05 C13; do
    python ./download-goes.py --bucket noaa-goes17 --year 2022 --month 7 --days 13 31 --product ABI-L1b-RadC --channel $channel --bounds -124 47 -121 49 --dir /storage/cdalden/goes/washington
done
